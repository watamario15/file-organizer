...
<h1>ビルドのログ</h1>
<h3>
--------------------構成 : eVC4 - Win32 (WCE x86) Release--------------------
</h3>
<h3>コマンド ライン</h3>
Creating command line "rc.exe /l 0x411 /fo"X86Rel/resource.res" /d UNDER_CE=400 /d _WIN32_WCE=400 /d "UNICODE" /d "_UNICODE" /d "NDEBUG" /d "WCE_PLATFORM_STANDARDSDK" /d "_X86_" /d "x86" /d "_i386_" /r "F:\Programming\File Separating\eVC4\resource.rc"" 
一時ファイル "C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP55C.tmp" を作成し、次の内容を記録します
[
...
"F:\Programming\File Separating\eVC4\1.cpp"
]
Creating command line "cl.exe @C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP55C.tmp" 
一時ファイル "C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP55D.tmp" を作成し、次の内容を記録します
[
...
コマンド ライン "link.exe @C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP55D.tmp" の作成中
<h3>アウトプット ウィンドウ</h3>
リソースをコンパイル中...
コンパイル中...
1.cpp
