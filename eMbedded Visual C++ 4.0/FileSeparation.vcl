...
一時ファイル "C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP7D.tmp" を作成し、次の内容を記録します
[
...
Creating command line "cl.exe @C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP7D.tmp" 
一時ファイル "C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP7E.tmp" を作成し、次の内容を記録します
[
...
コマンド ライン "link.exe @C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP7E.tmp" の作成中
<h3>アウトプット ウィンドウ</h3>
リソースをコンパイル中...
コンパイル中...
1.cpp
